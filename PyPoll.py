...
# Candidare Options (list) and candidate votes (dictionary)
candidate_options = []
...
#   And, set the winning_candidate equal ot the candidate's name.
...
# Determine the percentage of votes for each candidate by looping through the counts. 
# 1. Iterate through the candidate_llist.
for candidate_name in candidate_votes:
...
#   4. Print the candidate name and percentage of votes.
    print(f"{candidate_name}: received {vote_perentage:{2.2}}% of the vote.")    
